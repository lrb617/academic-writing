#!/usr/bin/env python3
"""通过多种 API 从 DOI、PMID、arXiv ID 或 URL 中提取引用元数据。"""
...
class MetadataExtractor:
    ...
    def _parse_url(self, url: str) -> Tuple[str, str]:
        ...
        # 兜底：从 URL 里直接抽 DOI（适用 Nature、Science 这些）
    ...
    def _extract_year_crossref(self, message: Dict) -> str:
        # 优先看 published-print，其次 published-online
